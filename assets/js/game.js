...
var fightOrskip = function() {
    // ask player if they'd like to fight or skip usinf fightOrSkip function
    var promptFight = window.prompt('Would you like to FIGHT or SKIP this battle? Enter "FIGHT" or "SKIP" to choose.');
    promptFight = promptFight.toLowerCase();
    // Conditional Recuisive Function Call
    if (promptFight === "" || promptFight === null) {
        window.alert("You need to provide a valid answer! Please try.")
        return fightOrskip();
    }
    ...
    if (promptFight === "skip" || promptFight === "SKIP" || promptFight === "Skip"){
        ...
        if (confirmSkip) {
            ...
            // subtract money fromnplayerMoney for skipping
